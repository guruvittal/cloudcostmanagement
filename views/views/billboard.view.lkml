view: billboard {
  sql_table_name: `BillingExport.Billboard` ;;
  ...
  dimension: credits_sum_amount {
    type: number
    sql: ${TABLE}.credits_sum_amount ;;
  }
  dimension: currency {
    type: string
    sql: ${TABLE}.currency ;;
...
view: billboard__tags {

  dimension: billboard__tags {
    type: string
    hidden: yes
    sql: billboard__tags ;;
  }
...
view: billboard__labels {

  dimension: billboard__labels {
    type: string
    hidden: yes
    sql: billboard__labels ;;
  }
  dimension: key {
    type: string
    sql: key ;;
...
view: billboard__credits {
  ...
  dimension: billboard__credits {
    type: string
    hidden: yes
    sql: billboard__credits ;;
  }
  dimension: full_name {
    type: string
    sql: full_name ;;
...
view: billboard__system_labels {

  dimension: billboard__system_labels {
    type: string
    hidden: yes
    sql: billboard__system_labels ;;
  }
  dimension: key {
    type: string
    sql: key ;;
...
view: billboard__project__labels {
...
view: billboard__project__ancestors {
