view: supply_chain_graph_filtered_view_aggregate {
  sql_table_name: `BillingExport.SupplyChainGraphFilteredView_Aggregate` ;;
...
view: supply_chain_graph_filtered_view_aggregate__tags {
  ...
  dimension: supply_chain_graph_filtered_view_aggregate__tags {
    type: string
    hidden: yes
    sql: supply_chain_graph_filtered_view_aggregate__tags ;;
  }
  dimension: value {
    type: string
    sql: value ;;
...
view: supply_chain_graph_filtered_view_aggregate__labels {

  dimension: key {
    type: string
    sql: key ;;
  }
  dimension: supply_chain_graph_filtered_view_aggregate__labels {
    type: string
    hidden: yes
    sql: supply_chain_graph_filtered_view_aggregate__labels ;;
  }
  dimension: value {
    type: string
    sql: value ;;
...
view: supply_chain_graph_filtered_view_aggregate__credits {
  drill_fields: [id]
  ...
  dimension: supply_chain_graph_filtered_view_aggregate__credits {
    type: string
    hidden: yes
    sql: supply_chain_graph_filtered_view_aggregate__credits ;;
  }
  dimension: type {
    type: string
    sql: type ;;
...
view: supply_chain_graph_filtered_view_aggregate__system_labels {

  dimension: key {
    type: string
    sql: key ;;
  }
  dimension: supply_chain_graph_filtered_view_aggregate__system_labels {
    type: string
    hidden: yes
    sql: supply_chain_graph_filtered_view_aggregate__system_labels ;;
  }
  dimension: value {
    type: string
    sql: value ;;
...
view: supply_chain_graph_filtered_view_aggregate__project__labels {
...
view: supply_chain_graph_filtered_view_aggregate__project__ancestors {
